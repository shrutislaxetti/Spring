...
public class UserController {
	...
	public ResponseEntity<Response> login(@RequestBody LoginDTO loginDTO,HttpServletResponse resp) throws LoginException {
	...
	public ResponseEntity<Response> register(@RequestBody RegistrationDTO registration)throws RegistrationException, MessagingException {
	...
	public ResponseEntity<Response> activateUser(@RequestParam("token") String token) throws AddressException, MessagingException, ActivationException {
